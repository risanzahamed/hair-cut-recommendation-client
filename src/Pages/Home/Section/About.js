...
const About = () => {
    return (
        <div className='lg:w-[1400px] mx-auto pt-24 pb-24' >
            <div className='grid place-items-center lg:grid-cols-2 grid-cols-1 gap-5'>
                ...
                <div className='flex justify-between'>
                    <div>
                        <img className='w-80 mr-3' src="https://radiustheme.com/demo/wordpress/themes/salion/wp-content/uploads/2021/03/figure1.jpg" alt="" srcset="" />
                    </div>
                    <div>
                        <img className='w-80' src="https://radiustheme.com/demo/wordpress/themes/salion/wp-content/uploads/2021/03/figure2.jpg" alt="" srcset="" />
                    </div>
                </div>
            </div>
        </div>
