        ...
        <div>
            <div>
                <div className="  mx-auto">
                    <div className='grid items-center lg:grid-cols-1 gap-16'>

                        <div className="flex items-center justify-center   sm:py-8 lg:px-4">
                            {/* Carousel for desktop and large size devices */}
                            <CarouselProvider data-aos="zoom-out-up" className="lg:block hidden" naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={3} visibleSlides={1} step={1} infinite={true}>
                                                ...
                                                <Slide index={0}>
                                                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                                        ...
                                                        <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                                                            ...
                                                            <div className="h-full p-24 items-end pb-6">
                                                                <h2 className='text-4xl font-semibold text-white'>Best hair solon recommandation</h2>
                                                                <p className='text-xl font-semibold text-white'> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore perspiciatis enim tempora deleniti, facilis non obcaecati nisi quibusdam modi aliquid similique tenetur! Veniam molestias dolorum excepturi cumque consequatur, eveniet assumenda!</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </Slide>
